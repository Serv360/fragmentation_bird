...
# project_path = main_path + "/code/fragmentation_bird/development/qgis/fragmentation.qgz"
# year = 2012
...
# output_path_alt = main_path + "/data/biodiversity/STOC/countingdata_2007_2023_alt.csv"
...
# output_path_sites_to_keep_all_three = main_path + "/data/biodiversity/STOC/sites_to_keep_all_three.csv"
# alt_path = main_path + "/data/biodiversity/STOC/countingdata_2007_2023_alt.csv"
...
# output_path_sites_to_keep_two_out_of_three = main_path + "/data/biodiversity/STOC/sites_to_keep_two_out_of_three.csv"
# alt_path = main_path + "/data/biodiversity/STOC/countingdata_2007_2023_alt.csv"
...
# output_path_sites_with_group_two_out_of_three = main_path + "/data/biodiversity/STOC/sites_with_group_two_out_of_three_5000.csv"
...
# output_path_sites_with_group_all_three = main_path + "/data/biodiversity/STOC/sites_with_group_all_three_5000.csv"
...
# features_output_all_three = main_path + "/data/fragmentation/computation/features_all_three_group0.gpkg"
# sites_with_group_all_three = main_path + "/data/biodiversity/STOC/sites_with_group_all_three_5000.csv"
# base_output_all_three = main_path + "/data/fragmentation/computation/base_all_three_group2.gpkg"
...
# features_output_two_out_of_three = main_path + "/data/fragmentation/computation/features_two_out_of_three_group4.gpkg"
# sites_with_group_two_out_of_three = main_path + "/data/biodiversity/STOC/sites_with_group_two_out_of_three_5000.csv" # 5000 here is because I constructed groups with a 5000 buffer separation
# base_output_two_out_of_three = main_path + "/data/fragmentation/computation/base_two_out_of_three_group4.gpkg"
...
# frag_working_folder = main_path + "/data/fragmentation/computation"
# year = 2018
# version = "all_three" # two_out_of_three
# group = 2
# file_features = f"features_{version}_group{group}.gpkg" 
# output_folder = main_path + "/data/fragmentation/results"
# file_output = f"results_{version}_group{group}_{year}.csv"
# input_path = fmain_path + "/code/qgis/fragscape_{version}_group{group}_{year}/outputs/reportingResultsCBC.gpkg"
...
# input_folder = main_path + "/data/fragmentation/results"
# groups = [0, 1, 2]
# version = "all_three"
# year = 2018
